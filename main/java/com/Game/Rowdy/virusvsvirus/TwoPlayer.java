...
public class TwoPlayer extends Activity implements View.OnClickListener
{
        ...
        try{
            ...
            for (i = 0; i < 140; i++)
            {
                if (v == box[i] && Integer.parseInt(box[i].getText().toString()) == 0)//check box is white or not
                {
                    ...
                    if ((i % 10 == 0 && i > 20 && i < 110) || (i % 10 == 1 && i > 21 && i < 111)&&(i % 10 == 2 && i > 22 && i < 112)) {
                        if (right(i, p) || up(i, p) || down(i, p))
                        {expfunction(i,p);}
                    } else if ((i % 10 == 9 && i > 29 && i < 119) && (i % 10 == 8 && i > 29 && i < 118)&&(i % 10 == 7 && i > 29 && i < 117)) {
                        if (left(i, p) || up(i, p) || down(i, p))
                        {expfunction(i,p);}
                    } else if ((i > 2 && i < 7) || (i > 12 && i < 17)||(i > 22 && i < 27)) {
                        if (left(i, p) || right(i, p) || down(i, p))
                        {expfunction(i,p);}
                    } else if ((i >112 && i < 117) || (i > 122 && i < 127)||(i > 132 && i < 137)) {
                        if (left(i, p) || right(i, p) || up(i, p))
                        {expfunction(i,p);}
                    } else if (i == 0 || i == 1 ||i==2|| i == 10 ||i == 11||i==12||i==20||i==21||i==22)
                    {if (down(i, p) || right(i, p))
                    {expfunction(i,p);}
                    } else if (i == 9 || i == 8 || i==7||i==17||i == 18 || i == 19||i==27||i==28||i==29)
                    {if (left(i, p) || down(i, p))
                    {expfunction(i,p);}
                    }
                    else if (i == 110 || i == 111 ||i==112|| i == 120 || i == 121||i==122|| i==130||i==131||i==132) {
                        if (right(i, p) || up(i, p))
                        {expfunction(i,p);}
                    } else if(i == 119 || i == 118 || i==117||i==127||i == 128 || i == 129||i==137||i==138||i==139){
                        if (left(i, p) || up(i, p))
                        {expfunction(i,p);}
                    } else {
                    ...
                    if (ex==false)
                    {
                        ...
                        {
                            //one left two right
                            if(leftrightrightmid(i,p))
                                expfunction(i,p);
                        }
                        else if(i==8 ||i==138)
                        {
                            //one right two left
                            if(leftleftrightmid(i,p))
                                expfunction(i,p);
                        }
                        else if((i>1 && i<8)||(i>131 &&i<138))
                        {
                            //check all left right
                            if(leftleftrightmid(i,p)||leftrightrightmid(i,p))
                                expfunction(i,p);
                        }
                        else if((i%10==0 && i>10 && i<120)||(i%10==9 && i>19 && i<129))
                        {
                            // check all up down
                            if(updowndownmid(i,p)&&upupdownmid(i,p))
                                expfunction(i,p);
                        }
                        else if(i%10==1 && i>11&&i<121)
                        {
                            //check all up down one left two right
                            if(leftrightrightmid(i,p)||upupdownmid(i,p)|updowndownmid(i,p))
                                expfunction(i,p);
                        }
                        else if(i%10==8 && i>18&&i<128)
                        {
                            //check all up down two left one right
                            if(leftleftrightmid(i,p)||upupdownmid(i,p)|updowndownmid(i,p))
                                expfunction(i,p);
                        }
                        else if(i>11 && i<18)
                        {
                            //check all left right two down one up
                            if(leftleftrightmid(i,p)||leftrightrightmid(i,p)||updowndownmid(i,p))
                                expfunction(i,p);

                        }
                        else if(i>121 &&i<128)
                        {
                            //check all left right one down two up
                            if(leftleftrightmid(i,p)||leftrightrightmid(i,p)||upupdownmid(i,p))
                                expfunction(i,p);
                        }
                        else
                        {if(i!=0 &&i!=9 && i!=130 && i!=139)
                        {
                            switch (i) {
                                case 11:    // one left two right one up two down
                                    if (leftrightrightmid(i, p) || updowndownmid(i, p))
                                        expfunction(i,p);
                                    break;
                                case 18:    // one right two left one up two down
                                    if (leftleftrightmid(i, p) || updowndownmid(i, p))
                                        expfunction(i,p);
                                    break;
                                case 121:   // one left two right one down two up
                                    if (leftrightrightmid(i, p) || upupdownmid(i, p))
                                        expfunction(i,p);
                                    break;
                                case 128:   // one right two left one down two up
                                    if (leftleftrightmid(i, p) || upupdownmid(i, p))
                                        expfunction(i,p);
                                    break;
                                default: // check for all cases
                                    if (leftrightrightmid(i, p) || upupdownmid(i, p) | updowndownmid(i, p) || leftleftrightmid(i, p))
                                        expfunction(i,p);
                                    break;
                            }
                        }
    ...
    public boolean updowndownmid(int c,int t)
    {
        if(Integer.parseInt(box[c+10].getText().toString())==t &&Integer.parseInt(box[c+20].getText().toString())==t &&Integer.parseInt(box[c-10].getText().toString())==t)
            return true;
        return false;
    }
    public boolean upupdownmid(int c,int t)
    {
        if(Integer.parseInt(box[c+10].getText().toString())==t &&Integer.parseInt(box[c-20].getText().toString())==t &&Integer.parseInt(box[c-10].getText().toString())==t)
            return true;
        return false;
    }
    public boolean leftrightrightmid(int c,int t)
    {
        if(Integer.parseInt(box[c+1].getText().toString())==t &&Integer.parseInt(box[c+2].getText().toString())==t &&Integer.parseInt(box[c-1].getText().toString())==t)
            return true;
        return false;
    }
    public boolean leftleftrightmid(int c,int t)
    {
        if(Integer.parseInt(box[c+1].getText().toString())==t &&Integer.parseInt(box[c-2].getText().toString())==t &&Integer.parseInt(box[c-1].getText().toString())==t)
            return true;
        return false;
    }
    public boolean right(int c,int t)//check for right 4 boxes
    {   int temp=c+4;
    ...
    public boolean left(int c,int t)//check for left 4 boxes
    {
        int temp=c-4;
        for(int j=c;j>temp;j--)
        {
    ...
    public boolean up(int c,int t)//check for upper 4 boxes
    {
        int temp=c-40;
    ...
    public boolean down(int c,int t)//check for down 4 boxes
    {
        int temp=c+40;
        for(int j=c;j<temp;j=j+10)
        {
    ...
    public void wonbox(int won)
    {
        ...
        exit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v)
            {
                if(getsound())
                    click.start();
                startActivity(new Intent(TwoPlayer.this,SelPlayer.class));
                finish();
            }
    ...
    public void restart(View v)
    {
        ...
        button1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v)
            {
                ...
                fullAds.startAdd(TwoPlayer.this);
                startActivity(new Intent(TwoPlayer.this,TwoPlayer.class).putExtra("pnames",names));
                dialog.cancel();
                finish();
            }
