...
public class FourPlayer extends Activity implements View.OnClickListener{
    ...
    int a[]=new int[4];
    Random r;
    int ran[][]={{1,2,3,4},{1,3,2,4},{1,4,3,2},{1,3,4,2},{1,2,4,3},{1,4,2,3},
                  {2,1,3,4},{2,3,1,4},{2,4,3,1},{2,3,4,1},{2,1,4,3},{2,4,1,3},
                   {3,1,2,4},{3,2,1,4},{3,4,2,1},{3,2,4,1},{3,1,4,2},{3,4,1,2},
                   {4,1,2,3},{4,2,1,3},{4,3,2,1},{4,2,3,1},{4,1,3,2},{4,3,1,2}};
    int numb,n;
    ...
    public void quit(View v)
    {
        ...
        final Dialog dialog = new Dialog(FourPlayer.this);
        ...
        switch(c)
        {
            ...
            case 4:
                if (checked==0)
                    ...
                    box[bx].setText("44");
                box[bx].setBackgroundResource(R.drawable.ybox);
                break;
        }
    ...
    public void colorname(int c)
    {
        switch(c)
        {
            ...
            case 4:
                pname.setText(names[c-1]);
                pname.setTextColor(Color.parseColor("#ffff8800"));
                picon.setBackgroundResource(R.drawable.yturn);
    ...
    public void wonbox(int won)
    {
        ...
        switch(won)
        {
            ...
            case 4:
                draw.setText("YOU WON");
                pwon.setText(names[won-1]);
                pwoni.setBackgroundResource(R.drawable.yturn);
                break;
        }
        ...
        exit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v)
            {
                if(getsound())
                    click.start();
                startActivity(new Intent(FourPlayer.this,SelPlayer.class));
                finish();
            }
    ...
    public void restart(View v)
    {
        ...
        button1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v)
            {
                ...
                fullAds.startAdd(FourPlayer.this);
                startActivity(new Intent(FourPlayer.this,FourPlayer.class).putExtra("pnames",names));
                dialog.cancel();
                finish();
            }
